...
from hand_manipulation.hand_project.env.relocation_env import (
    AdroitReloationEnv,
    AdroitRelocationScene,
)

scene = AdroitRelocationScene(
    ycb_object_id=-1, primitive="sphere", random_pose=False, density=1000, size=0.04
)
...
# =======================================================
def do_rollout(N, policy, T=1e6, env=None, env_name=None, pegasus_seed=None):
    """
    params:
